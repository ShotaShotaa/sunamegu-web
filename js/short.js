for (let i = 1; i <= 4; i++) {
  ...
  img.setAttribute("src", `images/7-31/short/image (${i}).webp`);
...
for (let i = 1; i <= 1; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/7-24/short/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
...
for (let i = 1; i <= 5; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/7-17/short/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
