for (let i = 1; i <= 0; i++) {
  ...
  img.setAttribute("src", `images/8-21/short/image (${i}).webp`);
...
for (let i = 1; i <= 0; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/8-14/short/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
...
for (let i = 1; i <= 2; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/8-7/short/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
