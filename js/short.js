for (let i = 1; i <= 1; i++) {
  ...
  img.setAttribute("src", `images/6-26/short/image (${i}).webp`);
...
for (let i = 1; i <= 1; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/6-19/short/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
...
for (let i = 1; i <= 1; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/6-12/short/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
