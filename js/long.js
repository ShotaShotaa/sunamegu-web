for (let i = 1; i <= 15; i++) {
  ...
  img.setAttribute("src", `images/6-26/long/image (${i}).webp`);
...
for (let i = 1; i <= 22; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/6-19/long/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
...
for (let i = 1; i <= 19; i++) {
  ...
  // img要素を作成する
  const img = document.createElement("img");
  img.setAttribute("src", `images/6-12/long/image (${i}).webp`);
  img.setAttribute("loading", "lazy");
  img.setAttribute("alt", "アルバイト情報");
