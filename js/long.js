...
source1.setAttribute('srcset', `./images/4-16/long/image (${i}).webp`);
source1.setAttribute('media', '(max-width:500px)');
source1.setAttribute('type', 'image/webp');
picture.appendChild(source1);

const source2 = document.createElement('source');
source2.setAttribute('srcset', `./images/4-16/long/image (${i}).jpg`);
source2.setAttribute('media', '(max-width:500px)');
picture.appendChild(source2);

const source3 = document.createElement('source');
source3.setAttribute('srcset', `./images/4-16/long/image (${i}).webp`);
source3.setAttribute('type', 'image/webp');
picture.appendChild(source3);

const img = document.createElement('img');
img.setAttribute('src', `./images/4-16/long/image (${i}).jpg`);
